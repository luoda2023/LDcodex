...
pub const SILENT_BINARY: &str = "ldcodex"; // LDCodex 启动器二进制名（与原版 Codex++ 区分，避免 NSIS 互杀/守卫冲突）
pub const MACOS_SILENT_EXECUTABLE: &str = "CodexPlusPlus";
pub const MANAGER_BINARY: &str = "LDCodexManager"; // LDCodex 管理工具二进制名（与原版 codex-plus-plus-manager 区分）
